...
% P1ArmiesLost=-1*((1-A1WinPCT)*(-A)+ A1WinPCT*(A2WinPCT*(-A)+(1-A2WinPCT)*(-A+1+MedP1Survivors(2))));
% P2ArmiesLost=-1*((1-A1WinPCT)*(-D+MedP2Survivors(1))+A1WinPCT*(A2WinPCT*(-A2-D+MedP2Survivors(2)+1)+(1-A2WinPCT)*(-A2-D)));
...
% P1ArmiesLost=-1*((1-A1WinPCT)*(-A)+ A1WinPCT*(-A+MedP1Survivors(1)));
